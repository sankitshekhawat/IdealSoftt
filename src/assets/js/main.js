...
const card1 = document.querySelectorAll(".hiringOption-1");
const card2 = document.querySelectorAll(".hiringOption-2");
const card3 = document.querySelectorAll(".hiringOption-3");

const price1 = document.querySelector(".price-display1");
const price2 = document.querySelector(".price-display2");
const price3 = document.querySelector(".price-display3");

card1.forEach((e) => {
  e.addEventListener("click", () => {
    price1.innerText = e.value;
    console.log(e.value);
  });
});
...
//     const priceDisplayId = form.dataset.target;
//     const priceDisplay = document.getElementById(priceDisplayId);
//     const selectedOption = form.querySelector(
//       'input[name^="hiringOption"]:checked'
//     );

//     if (selectedOption) {
//       // Define the prices for each designer
//       const designerPrices = {
//         "hourly-1": 50, // Example price per hour for Designer 1
//         "daily-1": 400, // Example price per day for Designer 1
//         "weekly-1": 2000, // Example price per week for Designer 1
//         "hourly-2": 60, // Example price per hour for Designer 2
//         "daily-2": 450, // Example price per day for Designer 2
//         "weekly-2": 2200, // Example price per week for Designer 2
//         "hourly-3": 70, // Example price per hour for Designer 3
//         "daily-3": 500, // Example price per day for Designer 3
//         "weekly-3": 3000, // Example price per week for Designer 3
//         // Add more prices for other designers as needed
//       };

//       const selectedPrice = designerPrices[selectedOption.id];
...
//   // Select all forms with class 'radio-form'
//   const forms = document.querySelectorAll(".radio-form");
...
//   // Initial price update for all forms
//   forms.forEach((form) => {
//     updatePrice.call(form); // Use call to set the context of "this" to the form
//   });
// });
