...
import HireData from '../../utils/HireData'

const HiringSection = () => {
  return (
    <section className="hiring-profile">
  <div className="container hiring-details">
    <div className="jumbotron text-center">
      <h1 className='text-black'>Hire Talents</h1>
      <p>Find the perfect freelancer for your project.</p>
    </div>
    l
    <div className="container hiring-manager">
      <div className="row">
      {HireData.map(({hireus,designation,hour,daily,week,price,hireme},index) =>
        <div className="col-md-4" key={index}>
          <div className="e-card playing">
            ...
            <div className="infotop">
              ...
              <br />
              <h3 className="hire-head text-black">{hireus}</h3>
              <h3 className='text-black'>{designation}</h3>
              <br />
              <div className="hire-detail">
                <form className="radio-form" data-target="price-display-1">
                  <input
                    className="hiringOption-1"
                    defaultChecked=""
                    defaultValue="$10"
                    name="hiringOption-1"
                    type="radio"
                    id="hourly-1"
                  />
                  <label htmlFor="hourly-1" className='text-black'>
                    <span />
                    {hour}
                  </label>
                  <input
                ...
                <span className="price-display1" id="price-display-1">
                  {price}
                </span>
              </div>
              <div>
