  ...
  return (
    <section className="news-section style-2 fix section-padding">
      <div className="shape-image">
        <img src="../img/news/bg-shape.png" alt="shape-img" />
      </div>
      <div className="container">
        ...
        <div className="row">
          {NewsData.map(
            (
              { imgsrc, date, month, designation, info, comh, arrow, tag, comments },
              index
            ) => (
              <div
                key={index}
                ...
                <div className="single-news-items-2">
                  ...
                  >
                    ...
                    <div className="news-content">
                      ...
                      <h4>
                        <a href="news-details.html" className="teamblog">
                          {info}
                        </a>
                      </h4>
                      <ul className="post-list">
                        ...
                        <li>
                          <a href="news-details.html" className="text-white">
                            {arrow}
                          </a>
                        </li>
                      </ul>
      ...
      <div className="page-nav-wrap mt-5 text-center">
        <ul>
          <li>
            <a className="page-numbers teamblog text-black" href="#" >
             <FaArrowLeftLong/>
            </a>
          </li>
          <li>
